# %%
import pandas as pd
df = pd.read_csv('mimichxtest.csv')
...
def build_prompt(i):
    ...
    return (
        ...
        f"What is this patient's probability of developing hypoxemia within the next 6 hours? "
        f"Provide a detailed analysis and also give the probability."
    )
